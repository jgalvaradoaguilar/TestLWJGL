...
public class Camera extends GameObject {
    ...
    protected float xLookingAt = 0.0f, yLookingAt = 0.0f, zLookingAt = 0.0f;

    /**
     * Construct a Camera at the given location. It will be unmoving,
     * with a radius of 0.
     * The up vector will be (0.0f, 1.0f, 0.0f)
     * The lookingAt vector will be (0.0f, 0.0f, 0.0f)
     * @param x x coordinate of center of object
     * @param y y coordinate of center of object
     * @param z z coordinate of center of object
     */
    public Camera(float x, float y, float z, String usuario) {
        super(x, y, z, usuario);
    }
     ...
     * @return the x component of the upvector of this object
     */
    public float getXLookingAt() {
        return this.xLookingAt;
    }
     ...
     * @return the y component of the upvector of this object
     */
    public float getYLookingAt() {
        return this.yLookingAt;
    }
     ...
     * @return the z component of the upvector of this object
     */
    public float getZLookingAt() {
        return this.zLookingAt;
    }

    /**
     * Set the Looking At Position of this object
     * @param xLookingAt New x Looking At Position
     * @param yLookingAt New y Looking At Position
     * @param zLookingAt New z Looking At Position
     */
    public void setLookingAt(float xLookingAt, float yLookingAt, float zLookingAt) {
    ...
    public void render() {
        gluLookAt(x, y, z, xLookingAt, yLookingAt, zLookingAt, xUpVector, yUpVector, zUpVector);
    }
}
//
